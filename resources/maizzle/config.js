...
| Google Fonts                          https://maizzle.com/docs/google-fonts/
  ...
  */
    ...
    googleFonts:
        'Montserrat:300,400,400i,700,800|Open+Sans:300,400,400i,700,700i,800&subset=cyrillic',
  ...
  */
    ...
    */
        ...
        purgeCSS: {
            content: ['layouts/**/*.*', 'partials/**/*.*', 'components/**/*.*'],
            whitelist: [],
            whitelistPatterns: [],
        },
  ...
  */
    ...
    browsersync: {
        ...
        port: 3000,
        tunnel: false,
        watch: ['layouts/**/*.*', 'partials/**/*.*', 'components/**/*.*'],
    },
